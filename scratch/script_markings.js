    ...
    function openDetailModal(symbol) {
      ...
      if (forbiddenUS.includes(cleanSym)) {
        document.getElementById('modalTitle').innerHTML = `<h3 style="color:#b91c1c; margin:0;">⚠️ CHART SYMBOL ERROR</h3>`;
      ...
      document.getElementById('modalBody').innerHTML = `
        ...
        <div style="background:#f8fafc; border:1px solid var(--border-color); padding:10px 14px; border-radius:8px; margin-bottom:12px; display:flex; justify-content:space-between; align-items:center; font-size:11px; font-weight:700;">
          <span style="color:var(--text-muted);">ℹ️ <i>Master Score measures setup quality, not probability of profit.</i></span>
        ...
        <!-- Strategy Chart Markings Header & Overlay Container -->

        <div style="margin-bottom:16px; border:1.5px solid #cbd5e1; border-radius:14px; overflow:hidden; box-shadow:0 4px 14px rgba(0,0,0,0.06);">
          <!-- Chart Header Badge Bar -->
          <div style="background:linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding:10px 16px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:8px;">
            <div style="display:flex; align-items:center; gap:8px;">
              <span style="font-size:13px; font-weight:900; color:#00d09c;">📍 CHART STRATEGY MARKINGS (${cleanSym})</span>
              <span style="background:rgba(255,255,255,0.1); color:#e2e8f0; font-size:10px; padding:2px 8px; border-radius:10px; font-weight:700;">REAL-TIME NSE LEVELS</span>
            </div>
            <div style="display:flex; gap:8px; font-size:11px; font-weight:800; flex-wrap:wrap;">
              <span style="background:rgba(16,185,129,0.2); border:1px solid #10b981; color:#34d399; padding:3px 8px; border-radius:6px;">🎯 T2: <b>₹${t2Val}</b> (+15%)</span>
              <span style="background:rgba(16,185,129,0.2); border:1px solid #10b981; color:#34d399; padding:3px 8px; border-radius:6px;">🎯 T1: <b>₹${t1Val}</b> (+8%)</span>
              <span style="background:rgba(59,130,246,0.2); border:1px solid #3b82f6; color:#60a5fa; padding:3px 8px; border-radius:6px;">⚡ ENTRY: <b>Above ₹${v.trigger_price || v.price || '—'}</b></span>
              <span style="background:rgba(239,68,68,0.2); border:1px solid #ef4444; color:#f87171; padding:3px 8px; border-radius:6px;">🛑 SL: <b>Below ₹${slVal}</b> (-6%)</span>
            </div>
          </div>

          <!-- Chart Area with Overlay Markers -->
          <div style="position:relative; height:410px; width:100%; background:#ffffff;">
            <!-- Visual Target/SL Markers floating overlay on right of chart -->
            <div style="position:absolute; right:14px; top:14px; z-index:10; display:flex; flex-direction:column; gap:6px; pointer-events:none;">
              <div style="background:rgba(6,78,59,0.92); color:#a7f3d0; border:1px solid #10b981; padding:4px 10px; border-radius:8px; font-size:10px; font-weight:900; box-shadow:0 2px 8px rgba(0,0,0,0.2); backdrop-filter:blur(4px);">🎯 TARGET 2: ₹${t2Val} (+15%)</div>
              <div style="background:rgba(6,78,59,0.92); color:#a7f3d0; border:1px solid #10b981; padding:4px 10px; border-radius:8px; font-size:10px; font-weight:900; box-shadow:0 2px 8px rgba(0,0,0,0.2); backdrop-filter:blur(4px);">🎯 TARGET 1: ₹${t1Val} (+8%)</div>
              <div style="background:rgba(30,58,138,0.92); color:#bfdbfe; border:1px solid #3b82f6; padding:4px 10px; border-radius:8px; font-size:10px; font-weight:900; box-shadow:0 2px 8px rgba(0,0,0,0.2); backdrop-filter:blur(4px);">⚡ STRATEGY ENTRY: ₹${v.price ?? '—'}</div>
              <div style="background:rgba(127,29,29,0.92); color:#fecaca; border:1px solid #ef4444; padding:4px 10px; border-radius:8px; font-size:10px; font-weight:900; box-shadow:0 2px 8px rgba(0,0,0,0.2); backdrop-filter:blur(4px);">🛑 STOP LOSS: ₹${slVal} (-6%)</div>
            </div>
